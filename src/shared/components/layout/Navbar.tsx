    ...
    <header className="w-full bg-white border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-8 text-sm">
          ...
          <Link href="/farms" className={navLinkClass("/farms")}>
            Farms
          </Link>
          <Link href="/factories" className={navLinkClass("/factories")}>
            Factories
          </Link>
          <Link
            href="/workingHostels"
            className={navLinkClass("/workingHostels")}
          >
            Working Hostels
          </Link>
          <Link href="/agencies" className={navLinkClass("/agencies")}>
            Agencies
          </Link>
